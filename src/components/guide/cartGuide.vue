<template>
  <div class="box-frame">
    ...
    <transition name="dish-slide">
      <OrderClickGuide class="guide" v-if="showOrderGuide" />
    </transition>
    <transition name="cart-slide">
      <BuyClickGuide class="guide" v-if="showBuyGuide" />
    </transition>
...
import OrderClickGuide from "./orderClick.vue";
import BuyClickGuide from "./buyClick.vue";
